...
float ICM_20948::magX(void) const
{
    return getMagUT(agmt.mag.axes.x);
}

float ICM_20948::magY(void) const
{
    return getMagUT(agmt.mag.axes.y);
}

float ICM_20948::magZ(void) const
{
    return getMagUT(agmt.mag.axes.z);
}

float ICM_20948::getMagUT(int16_t axis_val) const
{
    return (((float)axis_val) * 0.15);
}

float ICM_20948::accX(void) const
{
    return getAccMG(agmt.acc.axes.x);
}

float ICM_20948::accY(void) const
{
    return getAccMG(agmt.acc.axes.y);
}

float ICM_20948::accZ(void) const
{
    return getAccMG(agmt.acc.axes.z);
}

float ICM_20948::getAccMG(int16_t axis_val) const
{
    switch (agmt.fss.a)
    {
    case 0:
...
float ICM_20948::gyrX(void) const
{
    return getGyrDPS(agmt.gyr.axes.x);
}

float ICM_20948::gyrY(void) const
{
    return getGyrDPS(agmt.gyr.axes.y);
}

float ICM_20948::gyrZ(void) const
{
    return getGyrDPS(agmt.gyr.axes.z);
}

float ICM_20948::getGyrDPS(int16_t axis_val) const
{
    switch (agmt.fss.g)
    {
    case 0:
...
float ICM_20948::temp(void) const
{
    return getTempC(agmt.tmp.val);
}

float ICM_20948::getTempC(int16_t val) const
{
...
ICM_20948_Status_e ICM_20948::cfgIntAnyReaToClear(bool enabled)
{
    ICM_20948_INT_PIN_CFG_t reg;
    status = ICM_20948_int_pin_cfg(&_device, NULL, &reg); // read phase
    if (status != ICM_20948_Stat_Ok)
